...
## [Unreleased]
## [0.1.1](https://github.com/rolter-ai/rolter/compare/v0.1.0...v0.1.1) - 2026-09-05
...
- *(proxy)* fail closed on content parts gemini cannot carry ([#906](https://github.com/rolter-ai/rolter/pull/906)) by [@ormeilu](https://github.com/ormeilu)
...
- *(gateway)* expose scraped upstream engine metrics per provider [#850] ([#880](https://github.com/rolter-ai/rolter/pull/880)) by [@ormeilu](https://github.com/ormeilu)
- *(gateway)* plugin dispatch runtime [#509] ([#867](https://github.com/rolter-ai/rolter/pull/867)) by [@ormeilu](https://github.com/ormeilu)
...
### Performance
- *(gateway)* batched serde_json serialization [ROL-PERF] ([#986](https://github.com/rolter-ai/rolter/pull/986)) by [@ormeilu](https://github.com/ormeilu)
- preallocate sse chunk vectors [ROL-PERF] ([#876](https://github.com/rolter-ai/rolter/pull/876)) by [@ormeilu](https://github.com/ormeilu)
...
### Testing
- *(proxy)* cover every inferred interactions shape in the live smoke ([#908](https://github.com/rolter-ai/rolter/pull/908)) by [@ormeilu](https://github.com/ormeilu)
- *(proxy)* add dispatch-gated gemini interactions live smoke [#764] ([#881](https://github.com/rolter-ai/rolter/pull/881)) by [@ormeilu](https://github.com/ormeilu)
